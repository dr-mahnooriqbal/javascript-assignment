...
//         alert( 'congratulation!you are eligible to cast vote')
// }
...
//     }
//     else {
//         alert( 'sorry! you are not eligible to cast vote')
// }
...
// var WorldCupSquad = [ "c" ]
// var SelectedPlayers = WorldCupSquad.slice(6,11 )

// alert (" Final team members:" ${SelectedPlayers})
// var WorldCupSquad1=["Ali" , "Asad" , "Hamza"  , "zain" , "zaib" , "yousuf" , "ajmal", "ibrahim" ,"ahmed" , "dawood" , "saim" , "huzaifa" , "usman" , "abdullah" , "Mavia "]
// var SelectedPlayers1= WorldCupSquad1.slice(6,10);
// alert("final players:" + SelectedPlayers1)